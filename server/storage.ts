import { doctors, appointments, type Doctor, type InsertDoctor, type Appointment, type InsertAppointment, type DoctorWithNextAvailable, type AppointmentWithDoctor } from "@shared/schema";
...
export interface IStorage {
  ...
  getAppointmentsByPatient(patientEmail: string): Promise<AppointmentWithDoctor[]>;
  createAppointment(appointment: InsertAppointment): Promise<Appointment>;
  updateAppointmentStatus(id: number, status: string): Promise<Appointment | undefined>;
  checkTimeSlotAvailability(doctorId: number, date: string, time: string): Promise<boolean>;
}
...
export class MemStorage implements IStorage {
    ...
    const sampleDoctors: InsertDoctor[] = [
      {
        ...
        availableTimeSlots: ["9:00 AM", "10:30 AM", "11:00 AM", "2:30 PM", "3:00 PM", "4:30 PM"]
      },
      {
        ...
        availableDays: ["monday", "tuesday", "wednesday", "thursday", "friday"],
        availableTimeSlots: ["8:00 AM", "9:30 AM", "10:00 AM", "11:30 AM", "2:00 PM", "3:30 PM"]
      },
      {
        ...
        rating: 49,
        imageUrl: "https://images.unsplash.com/photo-1594824720693-b9aca4e8b57b?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
      ...
      },
      {
        ...
        availableDays: ["monday", "tuesday", "wednesday", "thursday", "friday"],
        availableTimeSlots: ["8:30 AM", "9:30 AM", "10:30 AM", "1:30 PM", "2:30 PM", "3:30 PM"]
      },
      {
  ...
  async getAppointmentsByPatient(patientEmail: string): Promise<AppointmentWithDoctor[]> {
  ...
  async checkTimeSlotAvailability(doctorId: number, date: string, time: string): Promise<boolean> {
